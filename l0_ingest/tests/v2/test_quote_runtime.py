...
from l0_ingest.v2.source.runtime.quote_runtime import PythonQuoteRuntime, RustQuoteRuntime
...
async def test_rust_quote_runtime_decodes_rows_and_indexes(monkeypatch):
    ...
    monkeypatch.setattr(
        "l0_ingest.v2.source.runtime.quote_runtime.l0_rust",
...
async def test_python_quote_runtime_maps_sdk_objects_to_contracts(monkeypatch):
    monkeypatch.setattr(
        "l0_ingest.v2.source.runtime.quote_runtime.MarketDataGateway",
