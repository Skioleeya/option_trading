...
- [x] **DEBT-L1-1 CLOSED (2026-04-02, impl-20260402-claude-audit-fixes-closeout)** `l1_compute/analysis/bsm_aggregation.py` 瀹告彃鍨归梽銈忕幢`bsm_fast.py` 閼辨艾鎮庨弨鍦暠 Rust owner `aggregate_from_greeks` 閹垫寧濯撮妴淇乪f: openspec/changes/impl-20260402-l1-bsm-numpy-rust-fallback/tasks.md
- [x] **DEBT-L1-2 CLOSED (2026-04-02, impl-20260402-claude-audit-fixes-closeout)** `l1_compute/aggregation/zero_gamma.py` 瀹告彃鍨归梽銈忕幢`streaming_aggregator` zero-gamma 閺€鍦暠 Rust owner `estimate_zero_gamma_level` 閹垫寧濯撮妴淇乪f: openspec/changes/impl-20260402-l1-streaming-aggregator-rust/tasks.md
