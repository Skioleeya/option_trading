...
export const TacticalTriad: React.FC<Props> = ({ uiState }) => {
    // If no backend state is loaded yet, fall back to safe defaults
    const state = uiState ?? {
        vrp: {
            value: "—", state_label: "VRP", color_class: "text-text-secondary",
            border_class: "border-bg-border", bg_class: "bg-[#1e1e1e]",
            shadow_class: "shadow-none", animation: "", sub_intensity: "LOW", sub_label: "NEUTRAL"
        },
        charm: {
            value: "—", state_label: "STABLE", color_class: "text-text-secondary",
            border_class: "border-bg-border", bg_class: "bg-[#1e1e1e]",
            shadow_class: "shadow-none", multiplier: null, sub_intensity: "LOW", sub_label: "STABLE"
        },
        svol: {
            value: "—", state_label: "S-VOL", color_class: "text-text-secondary",
            border_class: "border-bg-border", bg_class: "bg-[#1e1e1e]",
            shadow_class: "shadow-none", animation: "", sub_intensity: "LOW", sub_label: "NEUTRAL"
        }
    }
            ...
            <div className="grid grid-cols-3 gap-1.5">
                ...
                <div className="flex flex-col items-center">
                    ...
                    <div className="flex items-center gap-1 text-text-muted mb-0.5">
                        <Activity size={10} />
                        <span className="text-[10px] font-bold tracking-wider">{vrp.sub_intensity}</span>
                    </div>
                ...
                <div className="flex flex-col items-center">
                    ...
                    <div className="flex items-center gap-1 text-text-muted mb-0.5">
                        <Clock size={10} />
                        <span className="text-[10px] font-bold tracking-wider">{charm.sub_intensity}</span>
                    </div>
                ...
                <div className="flex flex-col items-center">
                    ...
                    <div className="flex items-center gap-1 text-text-muted mb-0.5">
                        <Triangle size={10} />
                        <span className="text-[10px] font-bold tracking-wider">{svol.sub_intensity}</span>
                    </div>
