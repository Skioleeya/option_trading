...
```bash
python3 tools/momentum_calibration/workflows/stage1_train.py --symbol SPY.US --end-date 2026-03-10
python3 tools/momentum_calibration/workflows/stage2_oos.py --symbol SPY.US --train-run-id <stage1_run_id>
python3 tools/momentum_calibration/workflows/stage3_weekly_roll.py --symbol SPY.US --anchor-date 2026-03-10
```
