...
try:
    ...
    import logging
    logging.getLogger(__name__).warning("rust_kernel not installed, falling back to pure Python")
    ...
    def _detect_vanna_flip(self, now_mono: float, current_corr: float | None) -> bool:
        ...
        if _NDM_RUST_AVAILABLE:
            try:
                ...
                return rust_kernel.detect_vanna_flip(now_mono, current_corr, list(self._corr_history))
            except Exception as e:
                import logging
