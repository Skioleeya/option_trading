...
from l1_compute.microstructure.vol_accel_v2 import VolAccelV2, SessionPhase
from l1_compute.time.ttm_v2 import (
    get_trading_ttm_v2,
...
class TestTTMv2:
    ...
    def test_gamma_floor_applied(self):
        ...
        from l1_compute.time.ttm_v2 import _GAMMA_FLOOR_MINUTES
