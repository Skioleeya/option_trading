"""l2_decision.observability.l2_instrumentation — OTel spans + Prometheus metrics.

Structure mirrors l1_compute/observability/l1_instrumentation.py.
...
try:
    ...
    _tracer = _otel_trace.get_tracer("l2_decision")
    _HAS_OTEL = True
except ImportError:
    _HAS_OTEL = False
