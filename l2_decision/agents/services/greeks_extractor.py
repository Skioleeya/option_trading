...
class GreeksExtractor:
    ...
    def compute(
        ...
        result = {
            ...
            "charm_exposure": summary.get("net_charm_raw_sum", summary.get("net_charm", 0.0)),
            "vanna_exposure": summary.get("net_vanna_raw_sum", summary.get("net_vanna", 0.0)),
