...
from l2_decision.feature_store.extractors_mm_flow import build_mm_flow_specs
...
from l2_decision.feature_store.extractors_vrp_impact import build_vrp_and_impact_specs
...
def build_default_extractors() -> list[FeatureSpec]:
    ...
    specs.extend(build_vrp_and_impact_specs(bundle))
    specs.extend(build_mm_flow_specs())
    return specs
