"""l2_refactor.feature_store.registry — YAML-based declarative feature and signal registration.
...
def load_signal_config(name: str, config_dir: Path | None = None) -> dict[str, Any]:
    ...
    Args:
        ...
        config_dir: Directory to search. Defaults to l2_refactor/config/signals/.
