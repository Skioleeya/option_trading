"""l2_refactor.feature_store.extractors — 12 pre-defined feature extractor specs.
...
Usage:
    from l2_refactor.feature_store.extractors import build_default_extractors
    store = FeatureStore()
...
from l2_refactor.feature_store.store import FeatureSpec
