"""l2_refactor.fusion.attention_fusion — Numpy-based attention-weighted signal fusion.
...
from l2_refactor.events.decision_events import FeatureVector, FusedDecision, RawSignal
