"""l2_refactor.reactor — L2DecisionReactor main pipeline orchestrator.
...
from l2_refactor.feature_store.extractors import build_default_extractors, reset_all_default_extractors
from l2_refactor.feature_store.store import FeatureStore
...
from l2_refactor.observability.l2_instrumentation import L2Instrumentation
...
class L2DecisionReactor:
    ...
    Consumes:
        EnrichedSnapshot (from l1_refactor.output.enriched_snapshot)
    ...
    async def decide(self, snapshot: Any) -> DecisionOutput:
        ...
        Args:
            snapshot: EnrichedSnapshot from l1_refactor (or duck-typed compat object).
